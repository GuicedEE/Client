# 🔄 Starter Prompt — Adopt Rules Repository in an Existing Project (Preconfigured)

This is a project‑scoped copy of the adoption prompt, preconfigured for the GuicedEE Inject Client. Use this file from the project root to align this repository with the Rules Repository model (Pact → Rules → Guides → Implementation) and refactor docs to the modular, forward‑only structure.
...
## 0) Provide Inputs
Pre‑filled for this project. Adjust if needed before running.

- Repository URL / local path: C:/Java/DevSuite/GuicedEE/client
- Org and project name: GuicedEE / Inject Client
...
- Detected/Chosen tech topics (tick):
  ...
  - Backend Reactive:
    - Core stacks:
      - [x] Vert.x 5 — ./rules/generative/backend/vertx/README.md
      - [ ] Hibernate Reactive 7 — ./rules/generative/backend/hibernate/README.md
    - Quarkus:
      - [ ] Core project setup
